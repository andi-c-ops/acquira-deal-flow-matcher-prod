...
const envSchema = z.object({
  ...
  GOOGLE_DRIVE_TOKEN_FILE: z.string().optional(),
  GOOGLE_DRIVE_TOKEN_JSON: z.string().optional(),
  GOOGLE_DRIVE_OAUTH_CLIENT_FILE: z.string().optional(),
  GOOGLE_DRIVE_OAUTH_CLIENT_JSON: z.string().optional(),
  GOOGLE_DRIVE_SNAPSHOT_FOLDER_ID: z.string().optional(),
